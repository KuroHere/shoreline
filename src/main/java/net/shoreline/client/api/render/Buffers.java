...
public class Buffers {
    public static final RenderBuffer QUADS = new RenderBuffer(VertexFormat.DrawMode.QUADS, VertexFormats.POSITION_COLOR);
    public static final RenderBuffer LINES = new RenderBuffer(VertexFormat.DrawMode.DEBUG_LINES, VertexFormats.POSITION_COLOR);
    ...
    public static class RenderBuffer {
        ...
        public RenderBuffer(VertexFormat.DrawMode drawMode, VertexFormat vertexFormat) {
        ...
        public RenderBuffer vertex(double x, double y, double z) {
            return vertex((float) x, (float) y, (float) z);
        }

        public RenderBuffer vertex(float x, float y, float z) {
