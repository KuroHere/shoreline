...
public class RequestUtil {
     ...
     */
    public static String get(String url, Map<String, String> headers, boolean followRedirects) {
     ...
     * @return the response in a String
     */
    public static String post(String url, Map<String, String> headers, boolean followRedirects, String body) {
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL(url).openConnection(PROXY);
            ...
            if (connection.getOutputStream() != null && body != null && !body.isEmpty()) {
     ...
     */
    public static HttpURLConnection post(String url, Map<String, String> headers, String body) {
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL(url).openConnection(PROXY);
     ...
     */
    private static void writeToOutputStream(OutputStream stream, String data) throws IOException {
        if (stream != null) {
     ...
     */
    public static String readConnection(HttpURLConnection connection) throws IOException {
     ...
     * @throws IOException if the input stream fails to read
     */
    private static String readInputStreamData(InputStream stream) throws IOException {
        if (stream == null) {
            return null;
        }
